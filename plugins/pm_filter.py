...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Your message has been sent to my moderators !</b>",
                             reply_markup=InlineKeyboardMarkup(
                                 [[
                                     InlineKeyboardButton('❣️ Mᴏᴠɪᴇ ɪs ʜᴇʀᴇ ❣️', url='https://t.me/cinemastorage5'),
                                     InlineKeyboardButton('💝 Mᴏᴠɪᴇ ɪs ʜᴇʀᴇ 💝', url='https://t.me/TGXMALLU_MOVIE'),
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('➕ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ ➕', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
                    ...
                    InlineKeyboardButton('🍁 Oᴡɴᴇʀ', url='https://t.me/CinemastoreOwner'),
                    InlineKeyboardButton('🌿 Sᴜᴘᴘᴏʀᴛ', callback_data="sup"),            
                  ],[
                    ...
                    InlineKeyboardButton('🔔 Subscribe', url='https://youtube.com/@CoolGamingICON?si=9EAy-OCqP60NnSHB'),
                  ],[
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('Gʀᴏᴜᴘ', url='https://t.me/CinemastoreOWNER'),
            InlineKeyboardButton('Cʜᴀɴɴᴇʟ', url='https://t.me/CinemastoreOWNER'),
            ], [
            InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ', url='https://t.me/XBOTSUPPORTS'),
            InlineKeyboardButton('Uᴘᴅᴀᴛᴇs', url='https://t.me/botuptest'),
            ], [
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
               [
                   InlineKeyboardButton(f'⭕ᴊᴏɪɴ ғᴏʀ ɴᴇᴡ ᴍᴏᴠɪᴇs⭕', url='https://t.me/cinemastorage5'),
               ]
               )
    btn.insert(1,
               [
        ...
        try:
            if message.chat.id == SUPPORT_CHAT_ID:
                await message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('Rᴇǫᴜᴇsᴛ ʜᴇʀᴇ ❣️', url='https://t.me/cinemastorage5'),
                            InlineKeyboardButton('Rᴇǫᴜᴇsᴛ ʜᴇʀᴇ 💝', url='https://t.me/TGXMALLU_MOVIE'),
            ...
            if message.chat.id == SUPPORT_CHAT_ID:
                await message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('Rᴇǫᴜᴇsᴛ ʜᴇʀᴇ ⭕', url='https://t.me/cinemastorage5'),
                            InlineKeyboardButton('Rᴇǫᴜᴇsᴛ ʜᴇʀᴇ 💝', url='https://t.me/TGXMALLU_MOVIE'),
                        ]]
                    )
                )
